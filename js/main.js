...
class BaseDeDatos {
  constructor() {
    this.productos = [];
    this.agregarRegistro(1, "Chocolate", 250, "chocolate", "../img/imagenchocolate.png");
    this.agregarRegistro(2, "Frutilla", 350, "chocolate", "../img/imagenfrutilla.jpg");
    this.agregarRegistro(3, "Vainilla", 450, "chocolate", "../img/imagenvainilla.png");
    this.agregarRegistro(4, "Naranja", 270, "chocolate", "../img/imagennaranja.jpg");
    this.agregarRegistro(5, "Chocolate 70%", 550, "chocolate", "../img/imagenchocolate.png");
    this.agregarRegistro(6, "Frutilla y Crema", 370, "chocolate", "../img/imagenfrutilla.jpg");
    this.agregarRegistro(7, "Limón", 150, "chocolate", "../img/imagenvainilla.png");
    this.agregarRegistro(8, "Cerezas", 270, "chocolate", "../img/imagenfrutos.jpg");
  }
